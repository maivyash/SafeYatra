        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <div className="photo-capture-section">
              {idProofFrontPhoto ? (
                <div className="captured-photo-preview">
                  <img
                    src={idProofFrontPhoto.base64}
                    alt="ID Front"
                    className="photo-thumbnail"
                  />
                  <div className="photo-info">
                    <p>
                      <strong>Format:</strong> {idProofFrontPhoto.format}
                    </p>
                    <p>
                      <strong>Size:</strong> {idProofFrontPhoto.size}
                    </p>
                    <p>
                      <strong>Captured:</strong>{" "}
                      {new Date(idProofFrontPhoto.capturedAt).toLocaleString()}
                    </p>
                  </div>
                  <button
                    type="button"
            ...
            {errors.idProofFrontPhoto && (
              <div className="error-message">{errors.idProofFrontPhoto}</div>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            <div className="photo-capture-section">
              {idProofBackPhoto ? (
                <div className="captured-photo-preview">
                  <img
                    src={idProofBackPhoto.base64}
                    alt="ID Back"
                    className="photo-thumbnail"
                  />
                  <div className="photo-info">
                    <p>
                      <strong>Format:</strong> {idProofBackPhoto.format}
                    </p>
                    <p>
                      <strong>Size:</strong> {idProofBackPhoto.size}
                    </p>
                    <p>
                      <strong>Captured:</strong>{" "}
                      {new Date(idProofBackPhoto.capturedAt).toLocaleString()}
                    </p>
                  </div>
                  <button
                    type="button"
            ...
            {errors.idProofBackPhoto && (
              <div className="error-message">{errors.idProofBackPhoto}</div>
            )}
          </div>
